        ...
        <div class="main__header" data-container-width="header-big" aria-hidden="true">
            <div class="main__header-row">
                    ...
                    >
                        ...
                        >
                            <g>
                                ...
                                ></path>
                                <path
                                    d="M60.5709 0.926025H55.1875V5.66608H60.5709V0.926025Z"
                                    fill="currentColor"
                                ></path>
                                <path
                                    d="M60.5326 9.0022H55.2246V28.4926H60.5326V9.0022Z"
                                    fill="currentColor"
                                ></path>
                                <path
                ...
                <div class="main__header-nav-center">
                    ...
                    <ul class="mega-menu">
                        <li class="mega-menu__item" data-mega-menu-item="true" aria-hidden="true">
                            <a class="mega-menu__item-button" data-item-button href="#">Menu 1</a>
                            <div class="mega-menu__submenu" data-mega-menu-submenu data-background="quarternary">
                                ...
                                <ul class="mega-menu__submenu-list" data-container-width="header-big">
                                    <li class="mega-menu__submenu-item" data-mega-menu-submenu-item="true" aria-hidden="true">
                                        ...
                                        <div class="mega-menu__submenu-item-submenu" data-mega-menu-submenu-item-submenu="true" data-background="quarternary">
                        ...
                        <li class="mega-menu__item" data-mega-menu-item="true" aria-hidden="true">
                            <a class="mega-menu__item-button" data-item-button href="#">Menu 2</a>
                            <div class="mega-menu__submenu" data-mega-menu-submenu data-background="quarternary">
                                <button type="button" class="mega-menu__submenu-go-back" data-button-go-back>
                                    <span class="mega-menu__title">Mega menu</span>
                                    <span class="mega-menu__close">Close</span>
                ...
                <div class="main__header-nav-last">
                    <button type="button" class="btn-main button--primary">

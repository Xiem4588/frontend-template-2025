export default class HeaderComponent extends HTMLElement {
    innerHTML = `
        <div class="main__header" data-container-width="header-big">
            <div class="main__header-row" data-layout-smart="four-per-row">
                <a
                    class="main__header-logo content-column-2"
                    href="#"
                    title="logo"
                >
                    <svg
                ...
                <div class="main__header-nav content-column-6"></div>
                <div class="main__header-nav content-column-4"></div>
            </div>
        </div>
    `;
}
